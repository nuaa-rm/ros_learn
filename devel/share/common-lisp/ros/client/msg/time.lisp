...
(cl:defmethod cl:initialize-instance :after ((m <time>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'time)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name client-msg:<time> is deprecated: use client-msg:time instead.")))

(cl:ensure-generic-function 'sec-val :lambda-list '(m))
(cl:defmethod sec-val ((m <time>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader client-msg:sec-val is deprecated.  Use client-msg:sec instead.")
  (sec m))
