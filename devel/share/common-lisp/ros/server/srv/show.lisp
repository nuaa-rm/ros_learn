...
(cl:defmethod cl:initialize-instance :after ((m <show-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'show-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name server-srv:<show-request> is deprecated: use server-srv:show-request instead.")))

(cl:ensure-generic-function 'request-val :lambda-list '(m))
(cl:defmethod request-val ((m <show-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader server-srv:request-val is deprecated.  Use server-srv:request instead.")
  (request m))

(cl:ensure-generic-function 'node_name-val :lambda-list '(m))
(cl:defmethod node_name-val ((m <show-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader server-srv:node_name-val is deprecated.  Use server-srv:node_name instead.")
  (node_name m))
...
(cl:defmethod cl:initialize-instance :after ((m <show-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'show-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name server-srv:<show-response> is deprecated: use server-srv:show-response instead.")))

(cl:ensure-generic-function 'response-val :lambda-list '(m))
(cl:defmethod response-val ((m <show-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader server-srv:response-val is deprecated.  Use server-srv:response instead.")
  (response m))
